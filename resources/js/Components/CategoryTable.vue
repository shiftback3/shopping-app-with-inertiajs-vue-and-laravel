<template>
  ...
  <section class="container px-4 mx-auto">
    <div class="items-right flex gap-x-3 mb-2">
      <Link
        ...
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          <div class="overflow-hidden md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead class="bg-gray-50 dark:bg-white-800">
                <tr>
                  <th
                    scope="col"
              ...
              >
                <tr v-for="(category, index) in categories" :key="index">
                  ...
                  >
                    <div
                      class="inline-flex items-center gap-x-3 text-gray-500 dark:text-gray-400"
                    >
                      <span>{{ index + 1 }}</span>
                    </div>
                  </td>
...
// window alert to confirm delete
const confirmDelete = (data) => {
  if (confirm("Do you want to delete Category?") == true) {
    // delete item
    router.delete(`/dashboard/category/${data.id}`, {
      onSuccess: () => {
